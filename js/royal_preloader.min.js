...
var Royal_Preloader = {
    ...
    }(), _background: function () { return "undefined" !== typeof Royal_Preloader && "undefined" !== typeof Royal_Preloader._background ? Royal_Preloader._background : ["#000000"] }(), _logo: function () { return "undefined" !== typeof Royal_Preloader && "undefined" !== typeof Royal_Preloader._logo ? Royal_Preloader._logo : "none" }(), _timeout: 10, _use_css_animation: !0, _css3SupportDetect: function () {
        var a = document.body.style; if ("string" == typeof a.transition) return Royal_Preloader._use_css_animation =
            !0; for (var b = ["Webkit", "Moz", "Khtml", "O", "ms"], c = 0; c < b.length; c++)if ("string" == typeof a[b[c] + "Transition"]) return Royal_Preloader._use_css_animation = !0; return Royal_Preloader._use_css_animation = !1
    }, _init: function () { Royal_Preloader._css3SupportDetect(); Royal_Preloader._total = 0; $.each(Royal_Preloader._images, function () { Royal_Preloader._total++ }); Royal_Preloader._build(); Royal_Preloader._load() }, _build: function () {
        this._overlay = $("<div>").attr("id", "royal_preloader").addClass(this._mode); this._overlay_bg =
